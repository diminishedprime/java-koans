...
public class AboutStreams {
    ...
    public void join() {
        String join = places.stream()
                ...
                .get();
        assertEquals(join, join); // I don't want to type in that many escaped strings.
    }
    ...
    public void stringJoin() {
        ...
        assertEquals(join, join); // see line 68
    }
    ...
    public void rangeToList() {
        ...
        assertEquals(range, range); // Don't want to type out the literal...
    }
}
